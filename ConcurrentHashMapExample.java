...
public class ConcurrentHashMapExample {
    public void example() {
        ...
        //iterate through the map (laptops), use Key Set method
        ...
        //Enumerate is to look through the list of items, similar to scanner, but is an iterator.
        ...
        //value cannot be null, nullpointerexception
        laptops.put("Microsoft", 18);
